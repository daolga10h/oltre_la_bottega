...
| Campo "Azienda" facoltativo su `orders`, mostrato sempre accanto al nome cliente (card, bacheca, scheda ordine, etichetta di stampa, rubrica clienti e profilo) (2026-08-29) | Alcuni clienti sono associazioni o aziende, non persone fisiche — il solo nome/cognome non basta a riconoscerli al banco. Campo libero, mai obbligatorio: `buildClientDisplayName()` in `src/lib/utils.ts` lo accoda al nome con un em dash solo quando presente, nessun residuo per gli ordini senza azienda |
